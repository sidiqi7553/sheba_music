...
import 'influencer_Maps.dart';
import 'influencer_Tickets_pricing.dart';

class influencer_Tickets_Details extends StatefulWidget {
  const influencer_Tickets_Details({Key? key}) : super(key: key);

  @override
  State<influencer_Tickets_Details> createState() => _Tickets_DetailsState();
}

class _Tickets_DetailsState extends State<influencer_Tickets_Details> {
  @override
        ...
        child: Container(
          ...
          child: ListTile(
            ...
            trailing: GestureDetector(
              onTap: () {
                Get.to(influencer_Tickets_pricing());
              },
              child: Container(
                height: 40,
                width: 140,
