...
import 'influencer_Going.dart';

class influencer_Deposit_Money extends StatefulWidget {
  const influencer_Deposit_Money({Key? key}) : super(key: key);

  @override
  State<influencer_Deposit_Money> createState() => _Deposit_MoneyState();
}

class _Deposit_MoneyState extends State<influencer_Deposit_Money> {
  @override
