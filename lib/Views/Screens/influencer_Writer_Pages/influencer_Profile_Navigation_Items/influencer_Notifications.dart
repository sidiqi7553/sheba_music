...
import 'influencer_Notification_Settings.dart';

class influencer_Notifications extends StatelessWidget {
  const influencer_Notifications({Key? key}) : super(key: key);
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: inner_Pages_App_Bar(
          nextscreen: influencer_Notification_Settings(),
          title: "Notifications",
