...
class Producer_Tickets_pricing extends StatefulWidget {
  const Producer_Tickets_pricing({Key? key}) : super(key: key);

  @override
  State<Producer_Tickets_pricing> createState() => _Tickets_pricingState();
}

class _Tickets_pricingState extends State<Producer_Tickets_pricing> {
