...
import 'Producer_Notification_Settings.dart';

class Producer_Notifications extends StatelessWidget {
  const Producer_Notifications({Key? key}) : super(key: key);
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: inner_Pages_App_Bar(
          nextscreen: Producer_Notification_Settings(),
          title: "Notifications",
