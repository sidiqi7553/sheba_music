...
import 'continue_with_phone_Producer.dart';
import 'forget_password_page_Producer.dart';
import 'register_page_Producer.dart';

class LoginPage_Producer extends StatefulWidget {
  const LoginPage_Producer({Key? key}) : super(key: key);

  @override
  State<LoginPage_Producer> createState() => _LoginPageState();
}

class _LoginPageState extends State<LoginPage_Producer> {
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Get.to(ContinueWithPhone_Producer());
              },
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  TextButton(
                    onPressed: () {
                      Get.to(ForgetPasswordPage_Producer());
                    },
                    child: AppText(
