...
import 'login_main_page_Producer.dart';
import 'verify_otp_page_Producer.dart';

class RegisterPage_Producer extends StatefulWidget {
  const RegisterPage_Producer({Key? key}) : super(key: key);

  @override
  State<RegisterPage_Producer> createState() => _RegisterPageState();
}

class _RegisterPageState extends State<RegisterPage_Producer> {
  int groupValue = 0;
