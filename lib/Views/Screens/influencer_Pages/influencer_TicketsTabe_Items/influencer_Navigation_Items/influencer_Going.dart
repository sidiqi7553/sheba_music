...
class influencer_Going extends StatefulWidget {
  const influencer_Going({Key? key}) : super(key: key);

  @override
  State<influencer_Going> createState() => _GoingState();
}

class _GoingState extends State<influencer_Going> {
  bool current = false;
