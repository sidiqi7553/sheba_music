...
class influencerProfileInArtist extends StatefulWidget {
  const influencerProfileInArtist({Key? key}) : super(key: key);

  @override
  State<influencerProfileInArtist> createState() => _Artist_ProfileState();
}

class _Artist_ProfileState extends State<influencerProfileInArtist> {
  var check = true;
  @override
