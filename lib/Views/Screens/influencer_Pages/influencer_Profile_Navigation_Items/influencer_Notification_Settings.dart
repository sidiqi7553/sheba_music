...
class influencer_Notification_Settings extends StatefulWidget {
  const influencer_Notification_Settings({Key? key}) : super(key: key);

  @override
  State<influencer_Notification_Settings> createState() => _Notification_SettingsState();
}

class _Notification_SettingsState extends State<influencer_Notification_Settings> {
  bool status1 = false;
  bool status2 = false;
  bool status3 = false;
  bool status4 = false;
