...
import 'Send_Tags.dart';

class Create_Screen_Influencer extends StatefulWidget {
  const Create_Screen_Influencer({Key? key}) : super(key: key);

  @override
  State<Create_Screen_Influencer> createState() => _Create_Screen_InfluencerState();
}

class _Create_Screen_InfluencerState extends State<Create_Screen_Influencer> {
  int current = 0;
