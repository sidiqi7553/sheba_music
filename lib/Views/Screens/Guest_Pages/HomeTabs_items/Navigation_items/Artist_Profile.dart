...
class Artist_Profile extends StatefulWidget {
  const Artist_Profile({Key? key}) : super(key: key);

  @override
  State<Artist_Profile> createState() => _Artist_ProfileState();
}

class _Artist_ProfileState extends State<Artist_Profile> {
  var check = true;
  @override
