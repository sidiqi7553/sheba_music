...
class RecentTransactions_SeeAll extends StatefulWidget {
  const RecentTransactions_SeeAll({Key? key}) : super(key: key);

  @override
  State<RecentTransactions_SeeAll> createState() => _RecentTransactions_SeeAllState();
}

class _RecentTransactions_SeeAllState extends State<RecentTransactions_SeeAll> {
  int current = 0;
