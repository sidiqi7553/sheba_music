...
class Deposit_Terms extends StatelessWidget {
  const Deposit_Terms({Key? key}) : super(key: key);
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: ListTile(
                  leading: AppText(text: "Our Deposit Policies", SizeofFont: 20,textcolor: white,),
                ),
              ),
              Padding(
