...
class Tickets_Details extends StatefulWidget {
  const Tickets_Details({Key? key}) : super(key: key);

  @override
  State<Tickets_Details> createState() => _Tickets_DetailsState();
}

class _Tickets_DetailsState extends State<Tickets_Details> {
  @override
                  ...
                  child: Column(
                    ...
                    children: [
                      AppText(
                          ...
                          SizeofFont: 17,
                          textcolor: white,WeightofFont: FontWeight.w800,),
                      AppText(
                      ...
                      Container(
                        ...
                        child: Center(
                          child: AppText(text: "Add to My Calender",SizeofFont: 10,textcolor: white,),
                        ),
                      ),
                    ],
                  ),
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: AppText(text: "See on map",SizeofFont: 10,textcolor: white,),
                          ),
                        ),
                      ),
                    ],
