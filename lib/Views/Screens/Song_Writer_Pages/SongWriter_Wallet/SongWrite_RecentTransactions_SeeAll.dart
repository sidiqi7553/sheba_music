...
class SongWrite_RecentTransactions_SeeAll extends StatefulWidget {
  const SongWrite_RecentTransactions_SeeAll({Key? key}) : super(key: key);

  @override
  State<SongWrite_RecentTransactions_SeeAll> createState() => _RecentTransactions_SeeAllState();
}

class _RecentTransactions_SeeAllState extends State<SongWrite_RecentTransactions_SeeAll> {
  int current = 0;
