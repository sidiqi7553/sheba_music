...
import '../Home_SongWriter_Navigation_items/SongWriter_LiveStreaming_SeeAll.dart';
import '../Home_SongWriter_Navigation_items/SongWriter_Profile_In_Artist.dart';
import '../Home_SongWriter_Navigation_items/SongWriter_TrendingVidoes_SeeAll.dart';
import '../Home_SongWriter_Navigation_items/SongWriter_Videopage.dart';
import '../Home_SongWriter_Navigation_items/SongWriter_in_SongWriter_SeeAll.dart';
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            Artist_New_Releases(),
            Trending_Artists(
              seeAll: SongWriterProfileInSongWriterSeeAll(),
              profilePage: SongWriterProfileInArtist(),
            ),
              ...
              child: Column(
                children: [
                  ListTile(
                    ...
                    trailing: InkWell(
                      onTap: () {
                        Get.to(SongWriterLiveStreaming_SeeAll());
                      },
                      child: AppText(
                        text: "See All",
                        SizeofFont: 15,
            ...
            Trending_Videos(
              ...
              seeAll: SongWriterTrendingVidoes_SeeAll(),
            ),
            Trending_Artists(
