...
import 'SongWriter_in_SongWriter_SeeAll.dart';
import 'SongWriter_Profile_In_Artist.dart';

class SongWriterProducers_SeeAll extends StatefulWidget {
  const SongWriterProducers_SeeAll({Key? key}) : super(key: key);

  @override
  State<SongWriterProducers_SeeAll> createState() => _Producers_SeeAllState();
}

class _Producers_SeeAllState extends State<SongWriterProducers_SeeAll> {
  @override
                  ...
                  child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return GestureDetector(
                          onTap: () {
                            Get.to(SongWriterProfileInSongWriterSeeAll());
                          },
                          child: Container(
                            height: 100,
                            width: 100,
