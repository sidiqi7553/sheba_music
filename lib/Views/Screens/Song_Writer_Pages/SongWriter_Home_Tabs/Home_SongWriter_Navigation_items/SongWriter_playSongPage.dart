...
class SongWriteraudioplayer extends StatefulWidget {
  const SongWriteraudioplayer({Key? key}) : super(key: key);

  @override
  State<SongWriteraudioplayer> createState() => _audioplayerState();
}

class _audioplayerState extends State<SongWriteraudioplayer> {
