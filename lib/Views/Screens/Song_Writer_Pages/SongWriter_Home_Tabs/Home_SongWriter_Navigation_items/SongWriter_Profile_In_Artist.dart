...
class SongWriterProfileInArtist extends StatefulWidget {
  const SongWriterProfileInArtist({Key? key}) : super(key: key);

  @override
  State<SongWriterProfileInArtist> createState() => _Artist_ProfileState();
}
