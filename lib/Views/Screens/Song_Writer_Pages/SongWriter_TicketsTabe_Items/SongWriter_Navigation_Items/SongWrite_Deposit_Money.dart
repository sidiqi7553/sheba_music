...
import 'SongWrite_Going.dart';

class SongWrite_Deposit_Money extends StatefulWidget {
  const SongWrite_Deposit_Money({Key? key}) : super(key: key);

  @override
  State<SongWrite_Deposit_Money> createState() => _Deposit_MoneyState();
}

class _Deposit_MoneyState extends State<SongWrite_Deposit_Money> {
  @override
