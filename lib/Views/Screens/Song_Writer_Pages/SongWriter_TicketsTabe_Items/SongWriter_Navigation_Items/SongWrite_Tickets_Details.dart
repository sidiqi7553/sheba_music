...
import 'SongWrite_Maps.dart';
import 'SongWrite_Tickets_pricing.dart';

class SongWriter_Tickets_Details extends StatefulWidget {
  const SongWriter_Tickets_Details({Key? key}) : super(key: key);

  @override
  State<SongWriter_Tickets_Details> createState() => _Tickets_DetailsState();
}

class _Tickets_DetailsState extends State<SongWriter_Tickets_Details> {
  @override
        ...
        child: Container(
          ...
          child: ListTile(
            ...
            trailing: GestureDetector(
              onTap: () {
                Get.to(SongWrite_Tickets_pricing());
              },
              child: Container(
                height: 40,
                width: 140,
