...
class SongWrite_Going extends StatefulWidget {
  const SongWrite_Going({Key? key}) : super(key: key);

  @override
  State<SongWrite_Going> createState() => _GoingState();
}

class _GoingState extends State<SongWrite_Going> {
  bool current = false;
