...
import 'SongWriter_Menu_Items/Discover_SongWriter.dart';
import 'SongWriter_Menu_Items/Home_SongWriter.dart';
import 'SongWriter_Menu_Items/Library_SongWriter.dart';
import 'SongWriter_Menu_Items/My_Profile_SongWriter.dart';
import 'SongWriter_Menu_Items/Search_SongWriter.dart';
import 'SongWriter_Menu_Items/Ticket_SongWriter.dart';
          ...
          Padding(
            ...
            child: Builder(builder: (context) {
              if (widget.selectedind == 0) {
                return  HHomeSongWriter();
              }
              if (widget.selectedind == 1) {
                return DiscoverSongWriter();
              }
              if (widget.selectedind == 2) {
                return SearchSongWriter();
              }
              if (widget.selectedind == 3) {
                return TicketsSongWriter();
              }
              if (widget.selectedind == 4) {
                return LibrarySongWriter();
              }
              else {
                return MyProfileSongWriter();
              }
            }),
          ),
