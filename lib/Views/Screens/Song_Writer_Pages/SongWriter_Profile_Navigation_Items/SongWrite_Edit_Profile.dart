...
class SongWrite_Edit_Profile extends StatefulWidget {
  const SongWrite_Edit_Profile({Key? key}) : super(key: key);

  @override
  State<SongWrite_Edit_Profile> createState() => _Edit_ProfileState();
}

class _Edit_ProfileState extends State<SongWrite_Edit_Profile> {
  PlatformFile? temp;
