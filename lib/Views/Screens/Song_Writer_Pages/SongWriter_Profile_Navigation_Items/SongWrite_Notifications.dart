...
import 'SongWritet_Notification_Settings.dart';

class SongWrite_Notifications extends StatelessWidget {
  const SongWrite_Notifications({Key? key}) : super(key: key);
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: inner_Pages_App_Bar(
          nextscreen: SongWrite_Notification_Settings(),
          title: "Notifications",
