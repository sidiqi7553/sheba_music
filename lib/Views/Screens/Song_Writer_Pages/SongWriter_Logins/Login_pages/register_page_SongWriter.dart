...
import 'login_main_page_SongWriter.dart';
import 'verify_otp_page_SongWriter.dart';

class RegisterPage_SongWriter extends StatefulWidget {
  const RegisterPage_SongWriter({Key? key}) : super(key: key);

  @override
  State<RegisterPage_SongWriter> createState() => _RegisterPageState();
}

class _RegisterPageState extends State<RegisterPage_SongWriter> {
  int groupValue = 0;
