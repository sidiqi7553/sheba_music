...
import 'continue_with_phone_SongWriter.dart';
import 'forget_password_page_SongWriter.dart';
import 'register_page_SongWriter.dart';

class LoginPage_SongWriter extends StatefulWidget {
  const LoginPage_SongWriter({Key? key}) : super(key: key);

  @override
  State<LoginPage_SongWriter> createState() => _LoginPageState();
}

class _LoginPageState extends State<LoginPage_SongWriter> {
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Get.to(ContinueWithPhone_SongWriter());
              },
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  TextButton(
                    onPressed: () {
                      Get.to(ForgetPasswordPage_SongWriter());
                    },
                    child: AppText(
            ...
            Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () {
                    Get.to(RegisterPage_SongWriter());
                  },
                  child: AppText(
                    text: "Register Here",
                    SizeofFont: 15,
