...
class Artist_RecentTransactions_SeeAll extends StatefulWidget {
  const Artist_RecentTransactions_SeeAll({Key? key}) : super(key: key);

  @override
  State<Artist_RecentTransactions_SeeAll> createState() => _RecentTransactions_SeeAllState();
}

class _RecentTransactions_SeeAllState extends State<Artist_RecentTransactions_SeeAll> {
  int current = 0;
