...
class MyProfileArtist extends StatefulWidget {
  const MyProfileArtist({Key? key}) : super(key: key);

  @override
  State<MyProfileArtist> createState() => _MyProfileState();
}

class _MyProfileState extends State<MyProfileArtist> {
  var check = true;
