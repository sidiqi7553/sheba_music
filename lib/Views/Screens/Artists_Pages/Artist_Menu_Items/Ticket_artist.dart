...
class TicketsArtist extends StatefulWidget {
  const TicketsArtist({Key? key}) : super(key: key);

  @override
  State<TicketsArtist> createState() => _TicketsState();
}

class _TicketsState extends State<TicketsArtist> {
