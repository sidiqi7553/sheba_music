...
class VerifyOtpPage_Artist extends StatefulWidget {
  const VerifyOtpPage_Artist({Key? key}) : super(key: key);

  @override
  State<VerifyOtpPage_Artist> createState() => _VerifyOtpPageState();
}

class _VerifyOtpPageState extends State<VerifyOtpPage_Artist> {
