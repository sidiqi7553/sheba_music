...
import 'login_main_page_Artist.dart';
import 'verify_otp_page_Artist.dart';

class RegisterPage_Artist extends StatefulWidget {
  const RegisterPage_Artist({Key? key}) : super(key: key);

  @override
  State<RegisterPage_Artist> createState() => _RegisterPageState();
}

class _RegisterPageState extends State<RegisterPage_Artist> {
  int groupValue = 0;
