...
import 'continue_with_phone_Artist.dart';
import 'forget_password_page_Artist.dart';
import 'register_page_Artist.dart';

class LoginPage_Artist extends StatefulWidget {
  const LoginPage_Artist({Key? key}) : super(key: key);

  @override
  State<LoginPage_Artist> createState() => _LoginPageState();
}

class _LoginPageState extends State<LoginPage_Artist> {
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Get.to(ContinueWithPhone_Artist());
              },
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  TextButton(
                    onPressed: () {
                      Get.to(ForgetPasswordPage_Artist());
                    },
                    child: AppText(
