...
class Artist_Edit_Profile extends StatefulWidget {
  const Artist_Edit_Profile({Key? key}) : super(key: key);

  @override
  State<Artist_Edit_Profile> createState() => _Edit_ProfileState();
}

class _Edit_ProfileState extends State<Artist_Edit_Profile> {
  PlatformFile? temp;
