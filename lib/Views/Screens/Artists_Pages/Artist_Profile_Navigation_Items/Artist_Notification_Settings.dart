...
class Artist_Notification_Settings extends StatefulWidget {
  const Artist_Notification_Settings({Key? key}) : super(key: key);

  @override
  State<Artist_Notification_Settings> createState() => _Notification_SettingsState();
}

class _Notification_SettingsState extends State<Artist_Notification_Settings> {
  bool status1 = false;
  bool status2 = false;
  bool status3 = false;
  bool status4 = false;
