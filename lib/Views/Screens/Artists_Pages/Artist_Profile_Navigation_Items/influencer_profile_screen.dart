...
import 'Messenger_Tabs/allow_tag_artist.dart';

class Influencer_Profile extends StatefulWidget {
  const Influencer_Profile({Key? key}) : super(key: key);

  @override
  State<Influencer_Profile> createState() => _Artist_ProfileState();
}

class _Artist_ProfileState extends State<Influencer_Profile> {
  var check = true;
  @override
                  ...
                  GestureDetector(
                    ...
                    child: ListTile(
                      leading: Column(
                        ...
                        children: [
                          AppText(text: "Influencer Name", SizeofFont: 20,WeightofFont: FontWeight.bold,textcolor: white,),
