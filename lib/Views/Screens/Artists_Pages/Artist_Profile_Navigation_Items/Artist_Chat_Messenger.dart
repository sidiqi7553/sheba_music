...
class Artist_Chat_Messenger extends StatefulWidget {
  const Artist_Chat_Messenger({Key? key}) : super(key: key);

  @override
  State<Artist_Chat_Messenger> createState() => _Chat_MessengerState();
}

class _Chat_MessengerState extends State<Artist_Chat_Messenger> {
