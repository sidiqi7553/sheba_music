...
class ArtistVideopage extends StatefulWidget {
  const ArtistVideopage({Key? key}) : super(key: key);

  @override
  State<ArtistVideopage> createState() => _VideopageState();
}

class _VideopageState extends State<ArtistVideopage> {
