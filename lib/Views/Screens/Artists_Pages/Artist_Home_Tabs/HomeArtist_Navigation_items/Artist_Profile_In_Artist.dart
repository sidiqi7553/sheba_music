...
class ArtistProfileInArtist extends StatefulWidget {
  const ArtistProfileInArtist({Key? key}) : super(key: key);

  @override
  State<ArtistProfileInArtist> createState() => _Artist_ProfileState();
}

class _Artist_ProfileState extends State<ArtistProfileInArtist> {
  var check = true;
  @override
