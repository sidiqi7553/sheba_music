...
import 'ArtistProfile_in_Artist_SeeAll.dart';
import 'Artist_Profile_In_Artist.dart';

class ArtistProducers_SeeAll extends StatefulWidget {
  const ArtistProducers_SeeAll({Key? key}) : super(key: key);

  @override
  State<ArtistProducers_SeeAll> createState() => _Producers_SeeAllState();
}

class _Producers_SeeAllState extends State<ArtistProducers_SeeAll> {
  @override
                  ...
                  child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return GestureDetector(
                          onTap: () {
                            Get.to(ArtistProfileInArtistSeeAll());
                          },
                          child: Container(
                            height: 100,
                            width: 100,
