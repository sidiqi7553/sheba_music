...
class ArtistLiveStreaminng extends StatefulWidget {
  ArtistLiveStreaminng({Key? key}) : super(key: key);

  @override
  State<ArtistLiveStreaminng> createState() => _LiveStreaminngState();
}

class _LiveStreaminngState extends State<ArtistLiveStreaminng> {
  String val = '';
