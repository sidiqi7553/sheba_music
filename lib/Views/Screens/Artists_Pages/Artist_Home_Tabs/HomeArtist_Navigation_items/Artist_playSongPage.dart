...
class Artistaudioplayer extends StatefulWidget {
  const Artistaudioplayer({Key? key}) : super(key: key);

  @override
  State<Artistaudioplayer> createState() => _audioplayerState();
}

class _audioplayerState extends State<Artistaudioplayer> {
