...
class ArtistNewReleases_SeeAll extends StatefulWidget {
  const ArtistNewReleases_SeeAll({Key? key}) : super(key: key);

  @override
  State<ArtistNewReleases_SeeAll> createState() => _NewReleases_SeeAllState();
}

class _NewReleases_SeeAllState extends State<ArtistNewReleases_SeeAll> {
  @override
