...
class Artist_Going extends StatefulWidget {
  const Artist_Going({Key? key}) : super(key: key);

  @override
  State<Artist_Going> createState() => _GoingState();
}

class _GoingState extends State<Artist_Going> {
  bool current = false;
