...
import 'Artist_Going.dart';

class Artist_Deposit_Money extends StatefulWidget {
  const Artist_Deposit_Money({Key? key}) : super(key: key);

  @override
  State<Artist_Deposit_Money> createState() => _Deposit_MoneyState();
}

class _Deposit_MoneyState extends State<Artist_Deposit_Money> {
  @override
