...
class Artist_Tickets_pricing extends StatefulWidget {
  const Artist_Tickets_pricing({Key? key}) : super(key: key);

  @override
  State<Artist_Tickets_pricing> createState() => _Tickets_pricingState();
}

class _Tickets_pricingState extends State<Artist_Tickets_pricing> {
