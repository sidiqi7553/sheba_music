...
import 'Producer_in_SongWriter_SeeAll.dart';
import 'Producer_Profile_In_Artist.dart';

class Producer_in_Producers_SeeAll extends StatefulWidget {
  const Producer_in_Producers_SeeAll({Key? key}) : super(key: key);

  @override
  State<Producer_in_Producers_SeeAll> createState() => _Producers_SeeAllState();
}

class _Producers_SeeAllState extends State<Producer_in_Producers_SeeAll> {
  @override
                  ...
                  child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return GestureDetector(
                          onTap: () {
                            Get.to(ProducerProfileInSongWriterSeeAll());
                          },
                          child: Container(
                            height: 100,
                            width: 100,
