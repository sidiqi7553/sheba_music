...
class ProducerNewReleases_SeeAll extends StatefulWidget {
  const ProducerNewReleases_SeeAll({Key? key}) : super(key: key);

  @override
  State<ProducerNewReleases_SeeAll> createState() => _NewReleases_SeeAllState();
}

class _NewReleases_SeeAllState extends State<ProducerNewReleases_SeeAll> {
  @override
