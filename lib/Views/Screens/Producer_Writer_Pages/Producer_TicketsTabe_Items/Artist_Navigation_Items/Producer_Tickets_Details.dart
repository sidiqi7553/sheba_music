...
import 'Producer_Maps.dart';
import 'Producer_Tickets_pricing.dart';

class Producer_Tickets_Details extends StatefulWidget {
  const Producer_Tickets_Details({Key? key}) : super(key: key);

  @override
  State<Producer_Tickets_Details> createState() => _Tickets_DetailsState();
}

class _Tickets_DetailsState extends State<Producer_Tickets_Details> {
  @override
        ...
        child: Container(
          ...
          child: ListTile(
            ...
            trailing: GestureDetector(
              onTap: () {
                Get.to(Producer_Tickets_pricing());
              },
              child: Container(
                height: 40,
                width: 140,
